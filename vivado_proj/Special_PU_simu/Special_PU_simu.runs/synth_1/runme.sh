...
HD_PWD='D:/OneDrive - HKUST Connect/ACCESS/Special_PU_proj/vivado_proj/Special_PU_simu/Special_PU_simu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log special_pu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source special_pu.tcl
